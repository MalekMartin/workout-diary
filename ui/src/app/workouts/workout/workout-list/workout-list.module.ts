...
import { MatCardModule, MatGridListModule, MatExpansionModule } from '@angular/material';
import { RouterModule } from '@angular/router';
import { PipesModule } from '../../../shared/pipes/pipes.module';

@NgModule({
    imports: [CommonModule, MatCardModule, MatGridListModule, RouterModule, PipesModule, MatExpansionModule],
